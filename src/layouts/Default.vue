...
<template>
  <div class="min-h-screen bg-slate-50">
    <div class="flex">
      <aside
        class="fixed left-0 top-0 z-40 flex h-screen w-64 flex-col border-r border-border bg-white"
      >
      ...
      <div class="ml-64 flex-1">
        <header
          class="sticky top-0 z-30 bg-white py-2.5 border-b border-border"
        >
